...
public class FilePullActivity extends Activity implements AdapterView.OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for (int i = 0; i < files.length; i++) {
			...
			card.setFootnote("Select folder to pull files to...");
	...
	private class FilePull extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... file) {
        	...
        	try {
    			...
    			//initialize file-pull protocol
    			String op = "file-pull=" + file[0];
